...
\addbibresource{Proposal TA New.bib}
...
\begin{center}
    ...
    {\Large\bfseries PENGEMBANGAN VISUALISASI \textit{DASHBOARD} DATA CAPAIAN HASIL UNTUK MONITORING DAN EVALUASI KINERJA (STUDI KASUS: INSTITUT TEKNOLOGI BANDUNG)}\\
     \vspace{4cm}
...
\begin{center}
  ...
  {\large\bfseries PENGEMBANGAN VISUALISASI \textit{DASHBOARD} DATA CAPAIAN HASIL UNTUK MONITORING DAN EVALUASI KINERJA
...
% ==========================================
	Pembimbing  \\
  \vspace{0.5cm} 
    \includegraphics[width=3cm]{image/TTD.jpg}\\ 
 \vspace{0.2cm}
	Prof. Ir. Kridanto Surendro, M.Sc., Ph.D.   \\[0.2cm]
	NIP. 19640812 199102 1 001 
% ==========================================
